...
class BackgroundWorkerApiImpl: BackgroundWorkerFgHostApi {
  ...
  private static let refreshTaskID = "com.greatmemories.app.background.refreshUpload"
  private static let processingTaskID = "com.greatmemories.app.background.processingUpload"
