...
Java_app_alextran_great_memories_NativeBuffer_allocate(
...
Java_app_alextran_great_memories_NativeBuffer_free(
        JNIEnv *env, jclass clazz, jlong address) {
    free((void *) address);
}

JNIEXPORT jlong JNICALL
Java_app_alextran_great_memories_NativeBuffer_realloc(
...
Java_app_alextran_great_memories_NativeBuffer_wrap(
        JNIEnv *env, jclass clazz, jlong address, jint capacity) {
    return (*env)->NewDirectByteBuffer(env, (void *) address, capacity);
}

JNIEXPORT void JNICALL
Java_app_alextran_great_memories_NativeBuffer_copy(
 ...
 */
JNIEXPORT jlong JNICALL
Java_app_alextran_great_memories_NativeBuffer_createGlobalRef(JNIEnv *env, jobject clazz, jobject obj) {
    if (obj == NULL) {
        return 0;
    }
