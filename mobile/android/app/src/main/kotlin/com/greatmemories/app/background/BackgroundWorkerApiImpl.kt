package com.greatmemories.app.background
...
class BackgroundWorkerApiImpl(context: Context) : BackgroundWorkerFgHostApi {
  ...
  companion object {
    private const val BACKGROUND_WORKER_NAME = "great-memories/BackgroundWorkerV1"
    private const val OBSERVER_WORKER_NAME = "great-memories/MediaObserverV1"
    private const val PERIODIC_WORKER_NAME = "great-memories/PeriodicBackgroundWorkerV1"
    const val ENGINE_CACHE_KEY = "great-memories::background_worker::engine"
