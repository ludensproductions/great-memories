package com.greatmemories.app.widget
...
import com.greatmemories.app.R
    ...
    provideContent {
      ...
      Box(
        modifier = GlanceModifier
          ...
          .clickable {
            val intent = Intent(Intent.ACTION_VIEW, deeplinkURL ?: "great-memories://".toUri())
          ...
          Column(
            ...
            if (widgetState == WidgetState.LOG_IN.toString()) {
              Box(
                ...
                Text("Log in to your Great Memories server", style = TextStyle(textAlign = TextAlign.Center, color = GlanceTheme.colors.primary))
              }
            } else {
              Row(
                verticalAlignment = Alignment.CenterVertically,
