...
import 'package:great_memories_mobile/widgets/common/app_bar_dialog/app_bar_dialog.dart';
...
class _GreatMemoriesLogoWithText extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedOpacity(
    ...
    child: SvgPicture.asset(
      context.isDarkTheme ? 'assets/great-memories-logo-inline-dark.svg' : 'assets/great-memories-logo-inline-light.svg',
      height: 40,
    ),
  );
}
