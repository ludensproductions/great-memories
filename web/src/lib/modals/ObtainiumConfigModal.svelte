    ...
    {#if inputUrl && inputApiKey && archVariant}
      <div class="content-center">
        ...
        <div class="flex place-content-center place-items-center">
          <a
            href={obtainiumLink}
            class="text-sm great-memories-form-label underline"
            target="_blank"
            rel="noreferrer"
            id="obtainium-link"
          >
