...
<BasicModal title={$t('app_download_links')} size="tiny" {onClose}>
  <div class="mx-auto flex max-w-50 flex-col gap-4">
    <a href="https://play.google.com/store/apps/details?id=com.greatmemories.app" target="_blank" id="play-store-link">
      <img class="mt-2 w-full" alt="Get it on Google Play" src={playStoreBadge} />
    </a>

    <a href="https://apps.apple.com/us/app/great-memories/id1613945652" target="_blank" id="app-store-link">
      <img class="mt-2 w-full" alt="Download on the App Store" src={appStoreBadge} />
    </a>

    <a href="https://f-droid.org/packages/com.greatmemories.app/" target="_blank" id="fdroid-link">
