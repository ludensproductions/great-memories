...
<div
  class="flex items-center text-sm {roundedBottom
    ? 'rounded-2xl'
    : 'rounded-t-lg'} h-full place-items-center gap-2 bg-gray-200 p-2 dark:bg-great-memories-dark-gray"
>
  <IconButton
    shape="round"
    color="secondary"
  ...
  />
  <input
    class="w-full gap-2 bg-gray-200 dark:bg-great-memories-dark-gray dark:text-white"
    type="text"
    {placeholder}
    bind:value={name}
    bind:this={inputRef}
