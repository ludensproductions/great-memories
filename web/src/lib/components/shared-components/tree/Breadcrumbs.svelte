...
<nav class="flex items-center py-2">
  ...
  <div
    class="w-full great-memories-scrollbar overflow-y-auto rounded-2xl border border-gray-100 bg-gray-50 p-2 dark:border-gray-900 dark:bg-great-memories-dark-gray/50"
  >
