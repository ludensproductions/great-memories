...
{#if dragStartTarget}
  ...
  <div
    class="fixed inset-0 flex size-full flex-col items-center justify-center bg-gray-100/90 text-great-memories-dark-gray dark:bg-great-memories-dark-bg/90 dark:text-great-memories-gray"
