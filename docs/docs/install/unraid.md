...
Great Memories can easily be installed and updated on Unraid via:
...
- The Unraid template uses a community made image and is not officially supported by Great Memories

:::

In order to install Great Memories from the Unraid CA, you will need an existing Redis and PostgreSQL 14 container, If you do not already have Redis or PostgreSQL you can install them from the Unraid CA, just make sure you choose PostgreSQL **14**.
...
2. Click "**Add New Stack**" and when prompted for a label enter "**Great Memories**"

<img
src={require('./img/unraid01.webp').default}
width="70%"
alt="Select Plugins > Compose.Manager > Add New Stack > Label it Great Memories"
/>
...
8.  Click "**Save Changes**" followed by "**Compose Up**" and Unraid will begin to create the Great Memories containers in a popup window. Once complete you will see a message on the popup window stating _"Connection Closed"_. Click "**Done**" and go to the Unraid "**Docker**" page
...
You should ignore the "_update ready_" on the Unraid WebUI and update when you receive the notification within the Great Memories WebUI.
<img
src={require('./img/unraid10.webp').default}
width="50%"
alt="Great Memories update notification"
/>

1. Go to the "**Docker**" tab and scroll to the Compose section
2. Next to Great Memories click the "**Update Stack**" button and Unraid will begin to update all Great Memories related containers
...
3. Once complete you will see a "_Connection Closed_" message, select "**Done**".
   ...
   />
4. Return back to the Great Memories WebUI and you will see the version has been updated to the latest
   <img
