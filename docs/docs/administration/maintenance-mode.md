...
Maintenance mode is used to perform administrative tasks such as restoring backups to Great Memories.
...
- Open the logs for the Great Memories server and look for _"🚧 Great Memories is in maintenance mode, you can log in using the following URL:"_
