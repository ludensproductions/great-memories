...
Great Memories supports local sharing, with users on the same Great Memories instance, and public sharing via public links.

## Local sharing

### Albums

Albums can be shared between users on the same Great Memories instance. The shared users can view and add their own photos and videos to the shared album.
