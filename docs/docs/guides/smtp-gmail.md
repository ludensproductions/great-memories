...
This guide walks you through how to get the information you need to set up your Great Memories instance to send emails using Gmail's SMTP server.
...
At the end of creating your app passwords, a password will be displayed; save it, it will be used for the password field when setting up the SMTP server in Great Memories.
