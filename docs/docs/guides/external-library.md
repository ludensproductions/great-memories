...
This guide assumes you are running Great Memories in Docker and that the files you wish to access are stored
...
Restart Great Memories by running `docker compose up -d`.
