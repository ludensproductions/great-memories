...
The OpenAPI client libraries need to be regenerated whenever there are changes to the `great-memories-openapi-specs.json` file. Note that you should not modify this file directly as it is auto-generated. See [OpenAPI](/api.md) for more details.
