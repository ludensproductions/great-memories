...
Los UUIDs BLE estÃ¡n hardcodeados en la app y en el servidor â€” igual que `_great_memories._tcp` y el puerto 2283. Son identificadores de protocolo, no secretos: BLE advertising es pÃºblico y cualquier scanner puede verlos. MÃºltiples Raspberry Pi con el mismo UUID no se interfieren porque cada dispositivo tiene un MAC address BLE Ãºnico.
